...
Authors performed some clean up and analysis of data which I will include here for data that will look and behave better.  

```{r Original Author Code}
#Import the data
...
#case study 
##subset set data in order to create file with the case study regimes
...
#subset complexity 1 and 2 and rbind to the CO2_Temp_pH
...
#To display the variables existing in data and their characteristics
str(data)

#DATA EXPLORATION 

#Before undertaking any statistical analysis, it is useful to explore the data.
#To summarize the variables in data4 type in 
summary(data)
...
Let's start by checking for colinearity.  
